package class2;
/*
Create a Java Program (any class with a main method) and name it Practice Variables In your program create 8 variables to store all different types of primitive data
Print the value of each variable
 */
public class T1PracticeVariables {// pascalCase
    public static void main(String[] args) {
        byte verySmallWholeNBox=127;
        short smallWholeNBox=127;
        int mostWidelyUsedWholeNumberBox=1256220; //camelCase
        long largeWholeNBox=124587777754141L;

        float mediumDecimalBox= 12532.5F;
        double largeDecimalBox= 123652541.126544552;
